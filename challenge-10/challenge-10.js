(function() {
    ...
    */
    if( sum ) {
        number1 = 30;
        number2 = 10;
        console.log( showOperationMessage( operationSignal, number1, number2 ), sum( number1, 
            number2 ) );
    } else {
    ...
    */
    ...
    if( error ) {
        number1 = 30;
        number2 = 10;
        console.log( showOperationMessage( operationSignal, number1, number2 ), error( number1, 
            number2 ) );
    } else {
        console.log( showErrorMessage( operationSignal ) );
    }
